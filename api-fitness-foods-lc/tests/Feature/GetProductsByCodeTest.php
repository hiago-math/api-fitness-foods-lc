...
class GetProductsByCodeTest extends TestCase
{
    /**
     ...
     * @return void
     */
    public function test_put_product_by_code()
    {
        $code = $this->createFakeProduct();
        $response = $this->put("/api/products/{$code}", ['nutriscore_score' => 9950]);
